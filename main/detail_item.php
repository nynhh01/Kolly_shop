<?php
    ...
    $sql_lk="SELECT * FROM products WHERE id_pro = '$id_pro'";
    $query_lk= mysqli_query($mysqli,$sql_lk);
    $product_item = mysqli_fetch_array($query_lk);

    if(!empty($_POST['add_to_cart'])) {
        $id_product = $product_item['id_pro'];
        $sql="INSERT INTO carts(id_order_user,id_product) 
...
<body>
    <div class="nav-back">
        <div class="max">
            <div class="nav">
                <div class="nav-left">
                    <ul>
                        <li><a href="?file=main&id_user=<?php echo $id_user; ?>">Trang chủ</a></li>
    ...
    <section class="detail--item">
        ...
        <div class="img">
            <div class="img1">
                <img src="<?php echo '../img_upload/'.$product_item['img_main']; ?>" alt="" width="300px">
            </div>
            <div class="img4">
                <img src="<?php echo '../img_upload/'.$product_item['img_sub1']; ?>" alt="" >
                <img src="<?php echo '../img_upload/'.$product_item['img_sub2']; ?>" alt="">
                <img src="<?php echo '../img_upload/'.$product_item['img_sub3']; ?>" alt="">
                <img src="<?php echo '../img_upload/'.$product_item['img_sub4']; ?>" alt="">
            </div>
        </div>
        <div class="item--book">
            <div class="item--name">
                <p class="name--tree"><?php echo $product_item['name_tree']; ?></p>
                <p class="tree__cost--current">GIÁ: <span class="cost--current"><?php echo $product_item['cost_current']; ?></span> VNĐ</p>
                <p class="tree__cost--old">GIÁ: <span class="cost--old"><?php echo $product_item['cost_old']; ?></span> VNĐ</p>
            </div>
            <div class="item--discription">
                <p><?php echo $product_item['description_tree']; ?></p>
            </div>
            <div class="item--size">
                <p>SIZE: </p>
            ...
            <div class="item--add">
                ...
                <div class="add--hover add--number">+</div>
                <div class="add--hover add--number">-</div>
            </div>
            
            <form action="" method="post">
                <input type="submit" name="add_to_cart" class="submit--add--cart" value="Thêm vào giỏ hàng">
            </form>
